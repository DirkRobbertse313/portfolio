<!-- ====== Hero Section Start -->
<div class="relative pt-[60px] lg:pt-[80px] pb-[110px] bg-white dark:bg-slate-600">
    <div class="container">
            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    <div class="clients pt-16">
                        <h6
                            class="font-normal text-xs flex items-center text-body-color dark:text-gray-300 mb-4"
                        >
            ...
            <div class="w-full lg:w-6/12 px-4">
                <div class="lg:text-right lg:ml-auto">
                    <div class="relative inline-block z-10 pt-11 lg:pt-0">
                        <img src="{{ url('/img/CodeStudio_7 Banner.png') }}" alt="hero"
