<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg mb-10">
        ...
        >
            ...
            >
                <div
                    class="w-full aspect-video relative z-20"
                >
                    <div
                        class="w-full h-full absolute top-0 left-0 p-3"
                    >
                        <!-- Thumbnail -->
                        <img
            ...
            >
                ...
                >
                    <svg
                        viewBox="0 0 16 15" class="fill-current w-8 h-8"
                    >
                        <path
        ...
        <!-- Video Content -->
        <div
            class="p-6 xl:p-7 2xl:p-9 h-[320px] overflow-hidden text-center"
        >
            <h3>
                <a
